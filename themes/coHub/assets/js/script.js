$(document).ready(function () {
  ...
  // Inline popup for local video (expects a hidden div with video element)
  $(".popup-inline").magnificPopup({
    ...
    callbacks: {
      open: function() {
        var v = document.getElementById('hero-inline-video');
        if (v) {
  ...
  // Social QR code popup (footer icons)
  $(".social-qr").each(function () {
    var $a = $(this);
    var qr = $a.data("qr");
    if (!qr) return;
    $a.magnificPopup({
